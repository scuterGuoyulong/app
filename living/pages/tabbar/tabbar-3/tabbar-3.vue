<template>
	<view class="content" :class="{'active':active}">
		<image class="logo" :class="{'active':active}" src="/static/img/live/live.png"  mode="aspectFit"></image>
		<view class="tabbar-box-wrap">
			<view class="tabbar-box">
				<view class="tabbar-box-item" @click="goToPage('/pages/tabbar-3-detial/tabbar-3-release/tabbar-3-release')">
					<image class="box-image" src="/static/img/live.png" mode="aspectFit"></image>
					<text class="explain">直播</text>
